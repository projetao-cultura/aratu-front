...
const Interesse = () => {
  ...
  // A função agora está tipada corretamente.
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
       {categories.map((category) => (
          ...
          >
            <Image source={{uri: category.link}}
                   style = {styles.img}
            />
            {/*
            <Icon
              ...
              size={24}
              color={selectedCategories[category.key] ? '#fff' : '#000'}
            />
            */}
...
const styles = StyleSheet.create({
  ...
  img: {
    ...
    marginBottom: 5, // Espaço abaixo da imagem
  },
  title: {
    fontFamily: 'Brixton',
    fontSize: 22,
  ...
  selectedCategory: {
    backgroundColor: '#A41623', // Cor quando selecionado
  },
  buttonText: {
    marginTop: 5,
    fontSize: 16,
